...
export const Ubicacion = () => {
  return (
    <div className='min-h-screen max-with-viewp div_iframe'>
      <h1 className='g-titles-h1 g-textgcolor-page g-contorno-texto'>Ubicacion</h1>
      <div className=' '>
        <p className='g-paragrapg-size '>Frente a la Plaza Independencia, en pleno centro de la ciudad de Tandil</p>
      </div>
